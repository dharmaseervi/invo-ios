...
enum InvoiceTemplate: String, CaseIterable, Identifiable {
    ...
    var subtitle: String {
        switch self {
        case .classic: return "Bold black header, GST-style boxes"
        case .modern: return "Violet accent, clean and colorful"
        case .minimal: return "Spare, whitespace-first, no fills"
        }
    }
}
