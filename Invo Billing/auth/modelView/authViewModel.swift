...
final class AuthViewModel: ObservableObject {
    ...
    func login() async {
        ...
        do {
            ...
            resetFields()
            SessionManager.shared.loadTokenFromKeychain()
    ...
    func deleteAccount() async -> Bool {
        ...
        guard let url = URL(string: "\(AppEnvironment.baseURL)/account") else {
            return false
        }
        ...
        if let token = KeychainManager.shared.loadToken() {
            ...
            print("🔑 Token found, sending delete request")
        } else {
        ...
        do {
            ...
            print("📡 Delete response status: \(http.statusCode)")
